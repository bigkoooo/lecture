// #1. setTimeout((딘위:ms) (code, delay)
// : delay 시간동안 기다리다가 code 실행

// 실행 결과: 1 -> 3 -> 2
// js에서는 setTimeout g함수를 사용했을 때, 기다리지 않고
// 바로 다음 구문을 실행함 
...
// #################################################
// #3. 콜백함수(callback)함수로 문제를 해결해보자!
// - 다른 함수의 실행이 끝난 뒤에 실행되는 함수
// - js에서 어떤 함수의 매개변수로 대입되는 함수

// 목표: 콘솔로그 하나 찍고, 3초뒤에 "고민끝"이랑 상품명, 가격이 올바르게 출력
